...
def cells_per_ml():
    ...
    cells_counted = title = st.text_input('Celulas en total por los cuadrantes: ')
    dilution_factor = title = st.text_input('Introduce el factor de dilución de la muestra: ')
